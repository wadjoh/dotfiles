# Generated by Powerlevel10k configuration wizard on 2025-02-20 at 16:20 PST.
...
# 2 lines, solid, full frame, green-ornaments, compact, few icons, concise,
...
() {
  ...
  function my_git_formatter() {
    ...
    # 󰢰 if have stashes.
    (( VCS_STATUS_STASHES        )) && res+=" ${clean}󰢰"
    # 'merge' if the repo is in an unusual state.
    [[ -n $VCS_STATUS_ACTION     ]] && res+=" ${conflicted}${VCS_STATUS_ACTION}"
    # 󱓌 if have merge conflicts.
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}󱓌"
